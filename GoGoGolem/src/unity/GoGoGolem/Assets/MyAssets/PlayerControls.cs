...
//     version 1.14.2
//     from Assets/MyAssets/PlayerControls.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/MyAssets/PlayerControls.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": []
        ...
        ~@PlayerControls()
        {
            ...
            UnityEngine.Debug.Assert(!m_CameraControl.enabled, "This will cause a leak and performance issues, PlayerControls.CameraControl.Disable() has not been called.");
        }
