...
async def handle_websocket_v2(
    ...
    try:
        while True:
            # 클라이언트로부터 메시지 수신
            with tracer.start_as_current_span("ws_receive_v2") as span:
                ...
                try:
                    if message_type == MessageType.SESSION_START:
                        ...
                        # ACK 응답
                        with tracer.start_as_current_span("ws_send_v2") as send_span:
                        ...
                        try:
                            ...
                            with tracer.start_as_current_span("session_merge_v2") as merge_span:
